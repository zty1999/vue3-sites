<template>
  <div class="notelist-container">
    <template v-if="group">
      <div v-for="(value, key) in group" :key="key">
        ...
        <div class="note-list" v-if="value.length">
          <div class="note-list-item" v-for="item in value" :key="item.id" @click="itemClick(item)">
            <p>{{ item.title }}</p>
    ...
    <!-- <div class="note-list" v-if="list.length">
                      <div class="note-list-item" v-for="item in list" :key="item.id" @click="itemClick(item)">
                        <p>{{ item.title }}</p>
                        <p class="secondary">{{ item.createdAt }}</p>
                      </div>
                    </div> -->
